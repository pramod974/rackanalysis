...
class DatasetGenerator:
            ...
            pipeline=[{'$sort':{'date':1}},
                 {"$group": {'_id':
                     {'supplier_terminal_name':'$supplier_terminal_name','supplier_name':'$supplier_name','account_type':'$account_type','product_name':'$product_name'}
                      ...
                      'en_terminal_name':{'$last':'$en_terminal_name'},
                      'product_type':{'$last':'$product_type'},
                      'product_category':{'$last':'$product_category'},

                      }} ,
                     {'$project' : {'en_terminal_name':'$en_terminal_name',
                         'product_category':'$product_category',
                         'product_type':'$product_type',
                         'Ratability_Monthly_Avg':'$Ratability_Monthly_Avg','supplier_terminal_name' :
    ...
    def InsertToContractCompliance(self,tsapData,monthname,year,db):
        try:
            ...
            tsapData['bymonth']=[]
            fullyearmonth=monthname+"_"+str(year)
            ...
            bymonth={"fullyearmonth":fullyearmonth,"monthname":monthname,"month":month,"year" : year,"ratability" : monthlyratability,'WeightedAvgMonthlyBase':WeightedAvgMonthlyBase,'WeightedAvgMonthlyBeg':WeightedAvgMonthlyBeg,'EOMReconciledLG':EOMReconciledLG,'WeightedAvgMonthlyBaseLessEOMReconciledLG':WeightedAvgMonthlyBaseLessEOMReconciledLG,'WeightedAvgMonthlyBegLessWeightedAvgMonthlyBase':WeightedAvgMonthlyBegLessWeightedAvgMonthlyBase}
...
if len(sys.argv)>=3:
    ...
    if 'contract_compliance' in collections:
